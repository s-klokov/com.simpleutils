...
public interface QuikListener {
    ...
    /**
     * Поставить исполняемый код в очередь на исполнение в потоке бизнес-логики слушателя.
     *
    ...
    /**
     * @return исполняемый код из очереди на исполнение или {@code null}, если очередь пуста
     */
    Runnable poll();
